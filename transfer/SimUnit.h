/*
 * SimUnit.h
 *   Ported from SimUnit.pas - a library of Pascal functions & procedures originally created in Nov 1999
 *   Author: Mark Sattolo <epistemik@gmail.com>
 * ------------------------------------------------------------------------------------------------------
 *   $File: //depot/Eclipse/CPP/Workspace/Sim68k/src/SimUnit.h $
 *   $Revision: #13 $
 *   $Change: 106 $
 *   $DateTime: 2011/02/13 18:18:30 $   
 */

#ifndef MHS_ECLIPSE_CPP_SIMUNIT_H
#define MHS_ECLIPSE_CPP_SIMUNIT_H
...
boolean CheckCond( boolean Cond, string Message )
{
  ...
  printf( "*** ERROR >> %s at instruction #%d for operation %s\n", Message, (PC-2), Mnemo[OpId] );
...
#endif // MHS_ECLIPSE_CPP_SIMUNIT_H
